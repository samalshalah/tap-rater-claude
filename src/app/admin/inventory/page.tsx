  ...
  return (
    <AdminShell>
      <section className="mx-auto max-w-7xl px-4 py-8 md:px-8 lg:py-12">
        ...
        <div className="mt-3">
          <h1 className="text-4xl font-black text-ink">Inventory</h1>
        ...
        {outOfStock.length > 0 ? (
          <div className="mt-6 rounded-md border border-line bg-white shadow-sm">
            <div className="border-b border-line p-4">
              <h2 className="text-lg font-black text-ink">Currently out of stock ({outOfStock.length})</h2>
            </div>
          ...
          <div className="mt-6 rounded-md border border-teal-100 bg-teal-50 p-4 text-sm font-semibold text-brand">
        ...
        <div className="mt-6 overflow-x-auto rounded-md border border-line bg-white shadow-sm">
          <div className="border-b border-line p-4">
            <h2 className="text-lg font-black text-ink">All active products ({activeProducts.length})</h2>
          </div>
