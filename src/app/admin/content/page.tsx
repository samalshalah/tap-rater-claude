  ...
  return (
    ...
    <section className="mx-auto max-w-6xl px-4 py-8 md:px-8 lg:py-12">
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-3">
        <Link href="/admin/content/homepage" className="rounded-2xl border border-line bg-white p-5 shadow-sm">
          <h2 className="font-semibold text-ink">Homepage</h2>
          <p className="mt-2 text-sm leading-6 text-muted">Hero text, buttons, featured labels.</p>
        </Link>
        <Link href="/admin/content/pages" className="rounded-2xl border border-line bg-white p-5 shadow-sm">
        ...
        <Link href="/admin/products" className="rounded-2xl border border-line bg-white p-5 shadow-sm">
