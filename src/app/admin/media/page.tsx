  ...
  return (
    <AdminShell>
      <section className="mx-auto max-w-7xl px-4 py-8 md:px-8 lg:py-12">
        <p className="text-sm font-black uppercase text-brand">Content</p>
        <div className="mt-3">
          <h1 className="text-4xl font-black text-ink">Media</h1>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_1.6fr]">
          ...
          <div className="rounded-md border border-line bg-white p-4 shadow-sm">
            <h2 className="text-lg font-black text-ink">{assets.length} registered assets</h2>
              ...
              {assets.map((asset) => (
                <div key={asset.id} className="rounded-md border border-line p-3">
                  {asset.assetType === "image" ? (
                    ...
                    <div className="flex aspect-square w-full items-center justify-center rounded-md bg-gray-50 text-xs text-muted">
                      Video asset
                    </div>
                  )}
